export default {
    accounts: {
      ...
      antiDegradeDesc: 'Stabilizes the account device identity, isolates conversations and caps burst concurrency. Known protocol conversions are allowed while lost input, tools and reasoning are blocked. Preview before applying; revert any time. Protection does not guarantee upstream model quality.',
      ...
      antiDegradeGenericScope: 'Generic protection (concurrency cap)',
      ...
      antiDegradeEffectiveTLS: 'Effective transport',
      antiDegradeEffectiveConcurrency: 'Effective concurrency cap',
      antiDegradeObserved: 'Handshake observed',
      antiDegradeComputed: 'Computed from configuration; no handshake observed yet',
      antiDegradeMode1Desc: 'For OpenAI OAuth / setup-token accounts. v3 uses standard transport without forcing a TLS template and keeps a stable identity seed, separate conversations and a concurrency cap. OAuth does not support max_output_tokens; that field is removed per endpoint capability.',
      antiDegradeMode2Desc: 'Mode 2 keeps the legacy full-convergence policy for comparison only. Preview or revert its configuration; Mode 1 guarantees do not apply.',
      antiDegradeApply: 'Apply',
      antiDegradeMode1: 'Mode 1: Compatibility protection v3',
      antiDegradeMode2: 'Mode 2: Full convergence',
      antiDegradeModeLegacy: 'Original compatibility',
      antiDegradeModeLegacyDesc: 'Uses the original sub2 session identity and Node.js 24 transport. Concurrency stays independently editable and is preserved when switching or reverting. Request integrity can be disabled, observed or enforced separately.',
      antiDegradeLegacyVersion: 'Original (no version)',
      antiDegradeDefaultTag: 'default',
      antiDegradeShowDiagnostics: 'Show diagnostic strategies',
      antiDegradeHideDiagnostics: 'Hide diagnostic strategies',
      ...
      antiDegradeRevertHint: 'Reverting restores the snapshot and overwrites manual changes made after applying.',
      antiDegradeImmediateHint: 'The protection switch, strategy apply and revert take effect immediately; other fields are saved with the footer button. Diagnostic strategies are for comparison only.',
      antiDegradeDisableTitle: 'Disable account protection?',
      antiDegradeDisableMessage: 'Disabling immediately restores the identity and transport settings managed by the strategy. The administrator-configured concurrency is kept. Unsaved edits stay in the form.',
      antiDegradeChangeStrategy: 'Effective strategy',
      ...
      requestIntegrity: 'Request integrity check',
      requestIntegrityHint: 'Independent of identity and transport. Strategy default: original compatibility observes only, Mode 1 enforces.',
      requestIntegrityDefault: 'Follow strategy default',
      requestIntegrityOff: 'Off',
      requestIntegrityObserve: 'Observe only (log differences)',
      requestIntegrityEnforce: 'Enforce',
      protectionLabel: 'Protection',
      protectionGenericLabel: 'Concurrency protection',
      protectionOn: 'on',
      protectionOff: 'off',
      protectionToggleOn: 'Enable account protection',
      protectionToggleOff: 'Disable account protection',
      protectionToggleConfirmMessage: 'Disabling restores the identity, transport or concurrency settings managed by the strategy. Protection does not guarantee model answer quality.',
      protectionToggleConfirm: 'Disable',
      protectionEnabledToast: 'Account protection enabled',
      protectionDisabledToast: 'Account protection disabled',
      protectionUpdateFailed: 'Failed to update account protection',
      protectionScopeDisabled: 'Protection disabled by an administrator',
      protectionScopeGeneric: 'Generic protection: concurrency cap only. Codex identity and request integrity are not available for this account; upstream model quality is not guaranteed.',
      protectionScopeCodex: 'Compatibility protection v3: stable device identity, session isolation, concurrency cap and request integrity; upstream model quality is not guaranteed.',
      protectionScopeSaved: 'Uses the saved protection strategy; open the account to see its capabilities',
      protectionBatchEnable: 'Enable protection',
      protectionBatchSuccess: 'Protection enabled for {count} accounts',
      protectionBatchPartial: 'Enabled for {success} accounts, {failed} failed; refresh and check',
      protectionBatchFailed: 'Batch enable failed, please retry',
